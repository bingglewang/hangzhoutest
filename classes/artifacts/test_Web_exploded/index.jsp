...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed" >
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="http://localhost:8080/page/user/userList.html" target="testDemo"><i class="layui-icon layui-icon-user"></i> <span >用户列表</span></a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon layui-icon-user"></i> <span >班组人员管理</span></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;"><i class="layui-icon layui-icon-user"></i> <span >班组人员列表</span></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
            <iframe id="testDemo" name="testDemo" src="http://localhost:8080/user/addUI.action" style="overflow: visible;"
